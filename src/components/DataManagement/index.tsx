...
const TELEMETRY_TYPES = [
  ...
  { id: "ai-traces", label: "AI Traces", group: "AI Monitoring" },
  { id: "ai-generations", label: "AI Generations", group: "AI Monitoring" },
  { id: "ai-metrics", label: "AI Metrics", group: "AI Monitoring" },
  { id: "ai-scores", label: "AI Scores", group: "AI Monitoring" },
